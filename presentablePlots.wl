...
exportPlot[plot_,opts:OptionsPattern[{ImageResolution->600,Export}]]:=Export[FileNameJoin[{NotebookDirectory[],FileBaseName[NotebookFileName[]]<>"_"<>ToString[Hash[plot]]<>".png"}],plot,ImageResolution->OptionValue[ImageResolution],(* this trick ensures that the remainder of options is passed to Export[], but restricted to the options known to Export[] *)Evaluate@(Sequence@@FilterRules[{opts},Options[Export]])]
