...
listSavedSymbols::usage="listSavedSymbols[] returns a list of saved symbols in string form by scanning the default data directory";
...
listDataDirectoryFiles[]:=FileNameTake[#,-1]&/@FileNames["*",setupEnvironments`projectDataDirectory[]];
listSavedSymbols[]:=FileBaseName/@FileNames["*."<>expressionFileEnding,projectDataDirectory[]];
End[]
